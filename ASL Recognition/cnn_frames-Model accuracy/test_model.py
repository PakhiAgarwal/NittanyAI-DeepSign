...
# #Read all the pictures in the subfolder under the folder for identification
...
#             index += 1
#     #Calculate the probability of correct prediction
...
# # Create a new function that reads the test data. Since the order of the data sets starts from 1, the dir_counter starts from 1.
# def read_testfile(path):
#     img_list=[]
#     label_lsit=[]
#     dir_counter=1
#     # Read the test set in different folders because the data in the data set has been consistent in length and width. All operations without resize
